...
const char *ssid = "Theerat";
const char *password = "0968927755";
#define buzzer D7

String GMAP_API_KEY = "AIzaSyCexNRok92S5vUnBBS3oS_FrMe9W7Qu9Cw";
#define LINE_TOKEN  "RcaEcfhTl9mXtHH6crl70UoSVTdOXc1px4Z9lXd0QgY"
...
void loop()
{
  ...
  LINE.notify("ได้รับการแจ้งเตือนเหตุด่วน GPS LINK : 192.168.1.40");
  smartdelay_gps(1000);
  ...
  if (gps.location.isValid()) 
  {
    ...
    html+="<title>BEAR SOS GPS</title>";
    html+="<style>#map{height:400px;width:100%;}</style>";
    html+="</head>";
    html+="<body>";
    html+="<center>BEAR SOS</center>";
    html+="<div id='map'></div>";
    html+="<script>";
    //MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
